...
public class Message {
	...
	public static class MessageEncoder implements Encoder.Text<Message> {
		...
		public String encode(Message message) throws EncodeException {
			return Json.createObjectBuilder().add("message", message.getMsg()).add("sender", message.getSentFrom())
					.add("receiver", message.getSentTo()).add("date", message.getSentDate().toString()).build()
					.toString();
		}
